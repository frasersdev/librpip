...
#define LIBRPIP_PINS_PWM0	0b00000000000001000001000000000000  //since there are two we will have to search for it. 12 is preferred.
#define LIBRPIP_PINS_PWM1	0b00000000000010000010000000000000  //since there are two we will have to search for it. 13 is preferred.
